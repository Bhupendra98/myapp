...
public class PostJournalActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void saveJournal() {
        ...
        if(!TextUtils.isEmpty(title) && !TextUtils.isEmpty(thoughts) && imageUri!=null){
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            collectionReference.add(journal).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(PostJournalActivity.this,"adding journal fails",Toast.LENGTH_SHORT).show();
                                }
                            });
            ...
            progressBar.setVisibility(View.INVISIBLE);
            Toast.makeText(PostJournalActivity.this,"else running",Toast.LENGTH_SHORT).show();
        }
    }
